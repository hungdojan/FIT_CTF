...
from fit_ctf_templates import get_template, TEMPLATE_FILES, TEMPLATE_DIRNAME
...
def testing():
    ...
    user_config = ctf_mgr.user_config_mgr.get_doc_by_filter(_id=ObjectId('661668b043f399218db70244'))
